...
router.get("/profile", usercontroller_1.default.getUsers);
router.get("/profile/:id", usercontroller_1.default.getUser);
...
router.delete("/profile/:id", usercontroller_1.default.deleteUser);
